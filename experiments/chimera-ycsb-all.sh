...
CLIENT_COUNTS=(36 40 44 48 52 56 60 64)
SERVER_COUNTS=(5)
WORKLOADS=("a" "b" "c")

# Extra feature flags specifically for the CHIMERA system
CHIMERA_EXTRA_FLAGS="--cache 1 --writeback 0"
...
for wl in "${WORKLOADS[@]}"; do
    ...
    WORKLOAD_FILE="oops-workload${wl}-uniform"
    ...
    for ns in "${SERVER_COUNTS[@]}"; do
        for nc in "${CLIENT_COUNTS[@]}"; do
            ...
            EXP_FOLDER_DM_ABD="${EXP_FOLDER_BASE}/workload-${WL_UPPER}/DM-ABD/${ns}servers/${nc}client"
