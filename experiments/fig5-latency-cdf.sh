...
"$SCRIPT_DIR"/run.sh chimera-exe fig5-latency-cdf/workload-A/CHIMERA oops-workloada 2 4 
"$SCRIPT_DIR"/run.sh chimera-exe fig5-latency-cdf/workload-B/CHIMERA oops-workloadb 2 4 
